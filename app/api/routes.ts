...
// CaterFlow domain routes (direct imports — outside modules/)
import eventsRouter from "./caterflow/events.routes";
import menusRouter from "./caterflow/menus.routes";
import staffRouter from "./caterflow/staff.routes";
import vendorsRouter from "./caterflow/vendors.routes";
